...
#%%
clf = lgb.LGBMClassifier(application = "multiclass",  learning_rate = 0.1, num_iterations=160, num_leaves = 300,\
     boosting_type="dart", max_depth = 6, max_bin = 200,\
     task ="train", class_weight={1:1.5, 2:2, 3:4, 4:5, 5:6},\
...
#filename = '/home/single3/mammo/mammo/sam/multiview/modelLGBM/studies2048_v2.sav'
