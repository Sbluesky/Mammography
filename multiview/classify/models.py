...
class ViewWiseModel(nn.Module):
    def __init__(self, pretrained=True):
        ...
        self.fc3 = nn.Linear(256,5) #for left breast
        self.fc5 = nn.Linear(512,5) #for right breast
        self.fc4 = nn.Linear(512,4) #for density
    ...
    def forward(self, left_CC, right_CC, left_MLO, right_MLO):
        ...
        output = {
            #"L_bi": torch.sigmoid(L_bi), "L_den": torch.sigmoid(L_den), "R_bi" : torch.sigmoid(R_bi),"R_den" : torch.sigmoid(R_den)
