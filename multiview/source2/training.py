...
def train_model(model, criterion, optimizer, lr_scheduler, train_dataloader, val_dataloader, n_epochs=50):
    ...
    for epoch in range(0, n_epochs):
        ...
        if loss_val.avg < valid_loss_min:
            torch.save(model.state_dict(), '/home/single4/mammo/mammo/sam/multiview/modeltruelabel/viewwise-top.pt')
            ...
            if count == 25:
                ...
                torch.save(model.state_dict(), '/home/single4/mammo/mammo/sam/multiview/modeltruelabel/viewwise-last.pt')
                Lossplot(trainLoss,validLoss,'viewwisev_truelabel.png')
                exit(-1)
...
torch.save(model_conv.state_dict(), '/home/single4/mammo/mammo/sam/multiview/modeltruelabel/viewwise-last.pt')
Lossplot(trainLoss,validLoss,'viewwise_truelabel.png')
# %%
