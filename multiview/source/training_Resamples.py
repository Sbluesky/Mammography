...
def train_model(model, criterion, optimizer, lr_scheduler, train_dataloader, val_dataloader, n_epochs=50):
    ...
    for epoch in range(0, n_epochs):
        ...
        if loss_val.avg < valid_loss_min:
            torch.save(model.state_dict(), '/home/single4/mammo/mammo/sam/multiview/models/viewwise-RS-top.pt')
            ...
            if count == 25:
                ...
                torch.save(model.state_dict(), '/home/single4/mammo/mammo/sam/multiview/models/viewwisev5-RS-last.pt')
                Lossplot(trainLoss,validLoss,'viewwise-RS.png')
                exit(-1)
...
# Using Imbalanced Dataset SAmpling
from torchsampler import ImbalancedDatasetSampler

#%%
train_dataloader = torch.utils.data.DataLoader(train_dl, sampler=ImbalancedDatasetSampler(train_dl), shuffle = True, batch_size = batch_size, num_workers = 2)
...
torch.save(model_conv.state_dict(), '/home/single4/mammo/mammo/sam/multiview/models/viewwise-RS-last.pt')
Lossplot(trainLoss,validLoss,'viewwise-RS.png')
# %%
