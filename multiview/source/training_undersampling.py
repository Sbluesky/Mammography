...
#%%
def train_model(model, criterion, optimizer, lr_scheduler, trainlist, val_dataloader, n_epochs=100):
    ...
    for epoch in range(0, n_epochs):
        ...
        train_dl = MultiClassMammo(trainlist[epoch%5], transform1 = tfms1, transform2 = tfms2) 
        ...
        if loss_val.avg < valid_loss_min:
            torch.save(model.state_dict(), '/home/single4/mammo/mammo/sam/multiview/models/viewwise-undersample-transform-top.pt')
            ...
            if count == 30:
                ...
                torch.save(model.state_dict(), '/home/single4/mammo/mammo/sam/multiview/models/viewwise-undersample-transform-last.pt')
                Lossplot(trainLoss,validLoss,'viewwisev-undersample-transform.png')
                exit(-1)
...
model_CNN.load_state_dict(torch.load('/home/single4/mammo/mammo/sam/multiview/models/viewwise-undersample-transform-last.pt'))
#%%
...
val_dl = MultiClassMammo(valdf, transform1 = tfms1, transform2 = tfms2)
...
torch.save(model_conv.state_dict(), '/home/single4/mammo/mammo/sam/multiview/models/viewwise-undersample-transform-last.pt')
Lossplot(trainLoss,validLoss,'viewwise-undersample-transform.png')
# %%
