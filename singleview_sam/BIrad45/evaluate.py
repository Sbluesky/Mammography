...
#%%
#%%
holdoutdf = pd.read_csv("/home/single2/mammo/mammo/data/updatedata/csv/singleview-holdout.csv")
#path of image
holdoutdf["path"] = "/home/single2/mammo/mammo/data/updatedata/crop-images/" + holdoutdf["study_id"] + "/" + holdoutdf["image_id"] + ".png"
# %%
...
holdout_dl = MultiClassMammo(holdoutdf[(holdoutdf["label_birad"] == 5) | (holdoutdf["label_birad"] == 4)], transform1 = tfms1, transform2 = tfms2)
# %%
...
model_mammo.load_state_dict(torch.load('/home/single2/mammo/mammo/sam/singleview_sam/BIrad45/models/class45-top-bi5x11-bi4x2-trf.pt'))
