...
def train_model(model, criterion, optimizer, lr_scheduler, train_dataloader, val_dataloader, n_epochs=25):
    ...
    for epoch in range(0, n_epochs):
            ...
            if loss_val.avg < valid_loss_min:
                torch.save(model.state_dict(), '/home/single2/mammo/mammo/sam/singleview_sam/SE-RESNET50/models/top.pt')
...
n_epochs = 12
batch_size = 4
count = 0 #bien dung de early stopping
train_dataloader = torch.utils.data.DataLoader(train_dl, shuffle = True, batch_size = batch_size, num_workers = 2)
val_dataloader = torch.utils.data.DataLoader(val_dl, shuffle = True, batch_size = int(batch_size/2), num_workers = 2)
...
torch.save(model_conv.state_dict(), '/home/single2/mammo/mammo/sam/singleview_sam/SE-RESNET50/models/last.pt')
# %%
